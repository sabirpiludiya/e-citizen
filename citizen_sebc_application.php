					...
					Terms and Conditions and Privacy Policy'); return false; }">
							...
							<div style=";background-color:rgba(255,255,255, 0.1);padding:10%;border-radius:10px 55px ">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="txt_father_name" value="<?php echo $txt_father_name; ?>"
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="txt_birth_place" value="<?php echo $txt_birth_place; ?>"
									 placeholder="Enter your Birth Place" >
								<div class="notice_add" align="left"><?php echo $err_birth_place; ?></div>
								</div><br/>
								
								<div class="form-group">
									<label><b>Job/Business</b></label>
									<input type="text" class="form-control" name="txt_job_business" value="<?php echo $txt_job_business; ?>"
									 placeholder="Enter your Job or Business" >
								<div class="notice_add" align="left"><?php echo $err_job_business; ?></div>
								</div><br/>
											
								<div class="form-group">
									<label><b>Job/Business Place</b></label>
									<input type="text" class="form-control" name="txt_job_business_place" value="<?php echo $txt_job_business_place; ?>"
									 placeholder="Enter your Job or Business" >
								<div class="notice_add" align="left"><?php echo $err_job_business_place; ?></div>
								</div><br/>			
											
								<div class="form-group">
									<label><b>Age</b></label>
									<input type="number" class="form-control" name="num_age" value="<?php echo $num_age; ?>"
									 placeholder="Enter your Age">
								<div class="notice_add" align="left"><?php echo $err_age; ?></div>
								</div><br/>
								
								<div class="form-group">
									<label><b>Caste/Sub-Caste</b></label>
									<input type="text" class="form-control" name="txt_caste_subcaste" value="<?php echo $txt_caste_subcaste; ?>"
									 placeholder="Enter Your Birth Place" >
								<div class="notice_add" align="left"><?php echo $err_caste_subcaste; ?></div>
								</div><br/>
								
								<div class="form-group">
									<label><b>Annual Income</b></label>
									<input type="text" class="form-control" name="txt_annual_income" value="<?php echo $txt_annual_incomee; ?>"
									 placeholder="Enter Your Birth Place" >
								<div class="notice_add" align="left"><?php echo $err_annual_income; ?></div>
								</div><br/>
											
								<div class="form-group">
									<label><b>Why do you need of this certificate?</b></label>
									<textarea cols="10" class="form-control" name="txt_cert_need" placeholder="Please write need here" ><?php echo $txt_cert_need; ?>
									</textarea>
