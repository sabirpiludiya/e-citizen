...
<html>
	<head>
		<title>Non-Creamylayer || E Citizen</title>
			...
			<!-- Banner -->
				<section id="banner">
					...
					<div class="inner" >
						...
						<header>
							<h2>Non-Creamylayer Certificate</h2>
						</header>
						...
						<div class="form-group">						
								<label><b>Caste Proof(Select Any One)</b></label><br/>
									<select>
										...
										<option><label><b>Self Attested Caste Certificate</b></label></option>
							...
							<div class="form-group">
								<label><b>Income Proof(Select Any One)</b></label><br/>
									<select>
										<option><label><b>Income Certificate</b></label></option>
										<option><label><b>Income Tax Return</b></label></option>
										<option><label><b>Certified Copy of Village</b></label></option>
									</select></div>
								<br/>
								
							<div class="form-group">
									<label><b>***Upload Message to display*****</b></label><br/>
									<div><input type="file" class="form-control" name="file_income_proof"><br/></div>
									<div class="notice_add" align="left"><?php echo $err_income_proof; ?></div>
							</div><br/>
							
							<div class="form-group">
									<label><b>Relationship Proof Affidavit:</b></label><br/>
									<div><input type="file" class="form-control" name="file_relation_proof_affidavit"><br/></div>
									<div class="notice_add" align="left"><?php echo $err_relation_proof_affidavit; ?></div>
							</div>
							<br>							
						
								<div class="form-group">
									<label><b>Caste Certificate of Father(True Copy)</b></label><br/>
									<input type="file" class="form-control" name="file_caste_certificate"><br/>
								<div class="notice_add" align="left"><?php echo $err_caste_certificate; ?></div>
								</div>
								<br>							
								
								<div class="form-group">
									<label><b>Recommendation of Talati</b></label><br/>
									<input type="file" class="form-control" name="file_recommendation"><br/>
								<div class="notice_add" align="left"><?php echo $err_recommendation; ?></div>
								</div><br>
								
								<div class="form-group">
									<label><b>Panchanamu</b></label><br/>
									<input type="file" class="form-control" name="file_panchnamu"><br/>
								<div class="notice_add" align="left"><?php echo $err_panchnamu; ?></div>
								</div><br>
