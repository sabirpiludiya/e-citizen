...
try{
    $stmt=$con->prepare("SELECT tbl_aadhar.name as name, tbl_income_cert.ic_birth_place as birth_place, tbl_income_cert.ic_id as serial_no, tbl_income_cert.ic_member_earn_family as other_income, tbl_income_cert.ic_total_income as total_income, tbl_income_cert.ic_photo as photo  FROM tbl_aadhar, tbl_income_cert WHERE tbl_aadhar.aadhar_id=tbl_income_cert.ic_aadhar_id");
    $stmt->execute();
