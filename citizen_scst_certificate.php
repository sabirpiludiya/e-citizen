						...
						<div class="form-group">						
								<label><b>Caste Proof(Select Any One)</b></label><br/>
									<select>
										...
										<option><label><b>Certificate of Caste with Pedhunamu</b></label></option>
									</select></div>
							<br/>
							...
							<div class="form-group">
									<label><b>RelationShip Proof</b></label><br/>
							...
							<div class="form-group">
									<label><b>Father's School Leaving Certificate(True Copy)</b></label><br/>
									<div><input type="file" class="form-control" name="file_migration_certificate"><br/></div>
									<div class="notice_add" align="left"><?php echo $err_migration_certificate; ?></div>
							</div><br/>
							
							<div class="form-group">
							<label><b>Proof Needed in Service Attachment</b></label><br/>
									<label><b>Birth Certificate(True Copy)</b></label><br/>
									<div><input type="file" class="form-control" name="file_migration_certificate"><br/></div>
									<div class="notice_add" align="left"><?php echo $err_migration_certificate; ?></div>
							</div><br/>
							
							<div class="form-group">
									<label><b>Caste Certificate given by Sarpanch(True Copy)</b></label><br/>
									<div><input type="file" class="form-control" name="file_migration_certificate"><br/></div>
									<div class="notice_add" align="left"><?php echo $err_migration_certificate; ?></div>
							</div><br/>
							
							<div class="form-group">
									<label><b>Caste Certificate given by Head of Nagarpalika(True Copy) </b></label><br/>
									<div><input type="file" class="form-control" name="file_migration_certificate"><br/></div>
									<div class="notice_add" align="left"><?php echo $err_migration_certificate; ?></div>
							</div><br/>
