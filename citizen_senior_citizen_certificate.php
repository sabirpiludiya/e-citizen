...
<html>
	<head>
		<title>Senior-Citizen || E Citizen</title>
			...
			<!-- Banner -->
				<section id="banner">
					...
					<div class="inner" >
						...
						<header>
							<h2>Senior-Citizen Certificate</h2>
						</header>
				...
				<div style="padding:5%;margin:0 auto;width:100%;text-align:left" align="center">
                	...
                	<form id="registerform" method="post" name="registerform" enctype="multipart/form-data" class="content">
						...
						<div class="form-group">						
								<label><b>Age Proof(Select Any One)</b></label><br/>
									<select>
										<option><label><b>Birth Certificate(True Copy)</b></label></option>
										<option><label><b>School Leaving Certificate(True Copy)</b></label></option>
										<option><label><b>Income Tax PAN Card(True Copy)</b></label></option>
										<option><label><b>Passport(True Copy)</b></label></option>
										<option><label><b>Civil Surgeon Certificate</b></label></option>
										<option><label><b>Driving Licence</b></label></option>
									</select></div>
							<br/>
							...
							<div class="form-group">
									<label><b>Affidavit Attached with Application</b></label><br/>
							...
							<div class="form-group">
									<label><b>Certificate of Talati</b></label><br/>
