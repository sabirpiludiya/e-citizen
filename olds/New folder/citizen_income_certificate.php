                	...
                	<form id="registerform" method="post" name="registerform" enctype="multipart/form-data" class="content">
							...
							<br/>
								...
								<div class="form-group">
									...
									<input type="file" class="form-control" name="file_income_proof"><br/>
									<div class="notice_add" align="left"><?php echo $err_income_proof; ?></div>
								</div><br/>
							
								<div class="form-group">
									<label><b>Ration Card</b></label><br/>
									<input type="file" class="form-control" name="file_ration_card"><br/>
								...
								<div class="form-group">
									...
									<input type="file" class="form-control" name="file_electricity_bill"><br/>
								...
								<div class="form-group">
									...
									<input type="file" class="form-control" name="file_affidavit"><br/>
