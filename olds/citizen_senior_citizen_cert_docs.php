...
<div class="row">
  ...
  <div class="leftcolumn">
    <div class="card">
	<form method="post" enctype="multipart/form-data">
	<div><b>  Certificate of Talati </b><br><img id="myImg" src="IMAGES/BANNER cl.jpg" alt="Snow" style="margin-left:75px;;width:100px;max-width:100px;"><br><input type="file"> <input type="submit" class="btns"  value="Upload Again" ></div>
	<!-- The Modal -->
	   </div>
  </div>
