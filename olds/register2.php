                	...
                	<form id="registerform" method="post" name="registerform" enctype="multipart/form-data" class="content">
							...
							<div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" minlength="12" maxlength="12" name="txt_aadharid" value="<?php echo $aadharid; ?>" placeholder="Enter Your Aadhar ID" onkeypress="return isNumber(event)" >
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="txt_mobile"  maxlength="10" value="<?php echo $mobile; ?>" placeholder="Enter Your Mobile No." onkeypress="return isNumber(event)">
								...
								<div class="form-group">
									...
									<input type="password" class="form-control" maxlength="15" name="txt_pwd" value="<?php echo $pwd; ?>" placeholder="Enter Your Password">
