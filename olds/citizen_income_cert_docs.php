...
<div class="row">
  ...
  <div class="leftcolumn">
    <div class="card">
	<form method="post" enctype="multipart/form-data">
	<div><b>Ration Card</b><br><img id="myImg" src="IMAGES/BANNER cl.jpg" alt="Snow" style="margin-left:75px;;width:100px;max-width:100px;"><br><input type="file"> <input type="submit" class="btns"  value="Upload Again" ></div>
	<!-- The Modal -->
	   </div>
  </div>
  ...
  <div class="leftcolumn">
    <div class="card">
	<form method="post" enctype="multipart/form-data">
	<div><b> Electricity Bill(True Copy)</b><br><img id="myImg" src="IMAGES/BANNER cl.jpg" alt="Snow" style="margin-left:75px;;width:100px;max-width:100px;"><br><input type="file"> <input type="submit" class="btns"  value="Upload Again" ></div>
	<!-- The Modal -->
	   </div>
  </div>
  ...
  <div class="leftcolumn">
    <div class="card">
	<form method="post" enctype="multipart/form-data">
	<div><b> Affidavit</b><br><img id="myImg" src="IMAGES/BANNER cl.jpg" alt="Snow" style="margin-left:75px;;width:100px;max-width:100px;"><br><input type="file"> <input type="submit" class="btns"  value="Upload Again" ></div>
	<!-- The Modal -->
	   </div>
  </div>
						...
						<form>
  								<div class="form-group" align="center">
									<input type="submit" style="color:#FFFFFF" class="button" name="btn_submit" class="btns"  style="height:100%;font-size:12px" value="Proceed">
								</div><br/>
						</form>
